...
struct  GUILayoutEntry_t6_177  : public Object_t
{
	...
	GUIStyle_t6_176 * ___m_Style_7;
};
struct GUILayoutEntry_t6_177_StaticFields{
	// UnityEngine.Rect UnityEngine.GUILayoutEntry::kDummyRect
	Rect_t6_49  ___kDummyRect_8;
